          ...
          <div className="py-20 xl:grid xl:grid-cols-3 xl:gap-8">
            <div className="grid grid-cols-2 gap-8 xl:col-span-2">
              ...
              <div className="space-y-12 md:grid md:grid-cols-2 md:gap-8 md:space-y-0">
                ...
                <div>
                  <h3 className="text-sm font-medium text-gray-700">Connect</h3>
                  <ul role="list" className="mt-6 space-y-6">
            ...
            <div className="mt-12 md:mt-16 xl:mt-0">
              ...
              <form className="mt-2 flex sm:max-w-md">
                ...
                <input
                  ...
                  autoComplete="email"
                  required
                  className="w-full min-w-0 appearance-none rounded-md border px-4 py-2 text-base text-gray-900 placeholder-gray-500 shadow-sm focus:border-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-900"
                />
